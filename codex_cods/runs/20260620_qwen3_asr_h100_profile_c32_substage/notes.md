...
- Consider a low-risk per-process cache keyed by audio fingerprint for repeated ASR inputs, caching loaded audio plus feature-extractor output and derived token counts.
