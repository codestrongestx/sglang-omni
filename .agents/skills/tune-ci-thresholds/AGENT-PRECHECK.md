...
```bash
python .agents/skills/tune-ci-thresholds/tune.py hosts-list
hostname
...
python .agents/skills/tune-ci-thresholds/tune.py --model tts precheck \
  --output-dir /tmp/precheck_tts

python .agents/skills/tune-ci-thresholds/tune.py --model qwen3-omni-v1 precheck \
